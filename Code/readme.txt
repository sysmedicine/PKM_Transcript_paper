This file includes the code for each figure, table and supplementary material. 
All the code is performed by R language (Version 3.5.1).
The expected output have been saved in an independent folder named as "Output" in the "Source_data" folder.
...
4. For Figure 4B, the homology models were built using Schrodinger Suite software (Schrödinger/2019-3, LLC, New York, NY). 
