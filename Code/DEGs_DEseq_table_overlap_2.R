DEGs_DEseq_table_overlap_2<-function(deg_DEseq_1,deg_DEseq_2,fdr){
  #function:extract DEGs based FDR value and DEGs overlapping analysis
  ...
  ########################################################################
  #first cancer
  index_up_1=which(as.numeric(deg_DEseq_1[,col.names="log2FoldChange"])>0&as.numeric(deg_DEseq_1[,col.names="padj"])<fdr)
  index_down_1=which(as.numeric(deg_DEseq_1[,col.names="log2FoldChange"])<0&as.numeric(deg_DEseq_1[,col.names="padj"])<fdr)
...
#####################################################################
  #second cancer
  index_up_2=which(as.numeric(deg_DEseq_2[,col.names="log2FoldChange"])>0&as.numeric(deg_DEseq_2[,col.names="padj"])<fdr)
  index_down_2=which(as.numeric(deg_DEseq_2[,col.names="log2FoldChange"])<0&as.numeric(deg_DEseq_2[,col.names="padj"])<fdr)
